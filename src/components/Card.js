    ...
    render() {
        return (
            ...
            <div className="tc bg-light-blue dib br3 pa3 ma3 grow bw2 shadow-5">
                ...
                className="br-100 h4 w4 dib ba b--red-05 pa2" alt="" title ={` ${this.props.username}`}/>
                <h2 className="f3 mb2">{this.props.name}</h2>
                <p className="f5 fw4 mid-gray mt0">{this.props.email}</p>
                <p className="f5 fw4 mid-gray mt0">City  <span className="b">{this.props.address}</span></p>
                <p className="f5 fw4 mid-gray mt0">Website  <span className="b">{this.props.website}</span></p>
            </div>
